...
export class TextItem extends MyDisplay {
  ...
  public noise: Point = new Point(Util.range(1), Util.range(1));
  ...
  constructor(opt:any) {
    ...
    this._input = this._inner.querySelector('input') as HTMLInputElement;
  ...
  public setInputValue(v: string): void {
    this._input.value = v;
  }
